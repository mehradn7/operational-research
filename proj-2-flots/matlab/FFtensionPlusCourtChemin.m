...
function [PLUSCOURTCHEMIN,longueur] = FFtensionPlusCourtChemin(nsuc, suc, long, sommet_depart, sommet_arrivee)
%% Initialisations
NSUC = nsuc;
n = size(NSUC,2);
...
MARQUE(sommet_depart) = true; % on marque le sommet a == 2 ( b == 1 (b,a) == 1)
%
...
PLUSCOURTCHEMIN(1) = sommet_arrivee;
%
%% Algorithme de FF
while ismember(sommet_arrivee,NONMARQUES) % Tant que b == 1 non marqué
